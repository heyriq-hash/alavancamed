...
import { CalendarIcon, Clock, Phone, Mail, Check, X, Plus } from "lucide-react"
...
export default function AgendaDermatoPage() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-slate-100 flex items-center justify-center p-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl">AgendaMed - Dermatologia</CardTitle>
    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="container mx-auto p-4 md:p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-3xl font-bold text-slate-900">AgendaMed - Dermatologia</h1>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                {appointments.length === 0 ? (
                  <p className="text-center text-slate-500 py-8">Nenhum agendamento criado ainda</p>
                ) : (
